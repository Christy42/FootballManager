from enums import OffenseFormation, PlayStyle, Side, OffAssignments, RunStyle, GenericOff
...
OFF_PLAY_LIST = {"ManCenterRun": OffensePlay(SINGLEBACK, PlayStyle.RUN,
                                             [OffAssignments.LEFT_BLOCK, OffAssignments.CENTER_BLOCK,
                                              OffAssignments.CENTER_BLOCK, OffAssignments.CENTER_BLOCK,
                                              OffAssignments.RIGHT_BLOCK, OffAssignments.ROUTE_RUNNING,
                                              OffAssignments.ROUTE_RUNNING, OffAssignments.ROUTE_RUNNING,
                                              OffAssignments.RUNNING, OffAssignments.RIGHT_BLOCK,
                                              OffAssignments.QB], Side.CENTER, GenericOff.REC4, "Man Center Run",
                 ...
                 "DriveSingleback": OffensePlay(SINGLEBACK, PlayStyle.PASS,
                                         [OffAssignments.LEFT_BLOCK, OffAssignments.CENTER_BLOCK,
                                          ...
                                          OffAssignments.RIGHT_BLOCK, OffAssignments.ROUTE_RUNNING,
                                          OffAssignments.ROUTE_RUNNING, OffAssignments.ROUTE_RUNNING,
                                          OffAssignments.SCAN_BLOCK, OffAssignments.ROUTE_RUNNING,
                                          OffAssignments.QB], Side.CENTER, GenericOff.REC4, "Man Center Run",
                 ...
                 "KickOff": OffensePlay(KICK_OFF, PlayStyle.SPECIAL,
                                        [OffAssignments.LEFT_BLOCK, OffAssignments.CENTER_BLOCK,
                                         ...
                                         OffAssignments.ROUTE_RUNNING, OffAssignments.ROUTE_RUNNING,
                                         OffAssignments.RUNNING, OffAssignments.RIGHT_BLOCK,
                                         OffAssignments.KICK], Side.CENTER, GenericOff.REC4, "Kick Off",
                                        "Kick Off", None),
                 "Kick": OffensePlay(KICK_OFF, PlayStyle.SPECIAL,
                                     [OffAssignments.LEFT_BLOCK, OffAssignments.CENTER_BLOCK,
                                      ...
                                      OffAssignments.ROUTE_RUNNING, OffAssignments.ROUTE_RUNNING,
                                      OffAssignments.RUNNING, OffAssignments.RIGHT_BLOCK,
                                      OffAssignments.KICK], Side.CENTER, GenericOff.REC4, "Kick", "Kick", None),
                 "Punt": OffensePlay(KICK_OFF, PlayStyle.SPECIAL,
                                     [OffAssignments.LEFT_BLOCK, OffAssignments.CENTER_BLOCK,
                                      ...
                                      OffAssignments.ROUTE_RUNNING, OffAssignments.ROUTE_RUNNING,
                                      OffAssignments.RUNNING, OffAssignments.RIGHT_BLOCK,
                                      OffAssignments.KICK], Side.CENTER, GenericOff.REC4, "Punt", "Punt", None)
                 }
